...
class p1ngProjectSelectionFilter extends sfFilter
{
  ...
  public function execute($filterChain)
  {
    if (((sfConfig::get('app_project_select_module') == $this->context->getModuleName()) && (sfConfig::get('app_project_select_action') == $this->context->getActionName())) ||
      ((sfConfig::get('app_project_select_module') == $this->context->getModuleName()) && ('index' == $this->context->getActionName())) ||
      ...
      (!$this->context->getUser()->isAuthenticated()) || ('sfGuardAuth' == $this->context->getModuleName()))
    {
      $filterChain->execute();
