...
/**
 * P1ngCustomer filter form base class.
 *
 * @package    p1ng
 * @subpackage filter
 ...
 */
abstract class BaseP1ngCustomerFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('p1ng_customer_filters[%s]');
