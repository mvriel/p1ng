...
/**
 * P1ngProject filter form base class.
 *
 * @package    p1ng
 * @subpackage filter
 ...
 */
abstract class BaseP1ngProjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'p1ng_customer_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('P1ngCustomer'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('p1ng_project_filters[%s]');
